...
class GUI(Tk):
    ...
    def redraw(self, event=None):
        ...
        for t in range(self.gw.w * self.gw.h):
            ...
            value = f[y][x]
            if value == '#':
                self.gw.tiles[t] = gridworld.TILE_WALL
            x *= self.tileW
            y *= self.tileH
            ...
            # Draw goal
                ...
                self.canvas.create_rectangle(x + 1,
                                             ...
                                             fill="green",
                                             outline="green")
            elif self.gw.tiles[t] == gridworld.TILE_PATH:
                filled = True
                self.canvas.create_rectangle(x + 1,
                                             y + 1,
                                             x + self.tileW,
                                             ...
                                             fill="yellow",
                                             outline="yellow")
            if self.gw.tiles[t] == gridworld.TILE_OPEN:
                filled = True
                self.canvas.create_oval(x + 3,
                                             ...
                                             fill="purple",
                                             outline="purple")
            if self.gw.tiles[t] == gridworld.TILE_CLOSED:
                filled = True
                self.canvas.create_oval(x + 3,
                                             y + 3,
                                             x + self.tileW-2,
